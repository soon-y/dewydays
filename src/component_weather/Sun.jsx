export default function Sun({daytime, phase}){
  ...
  return(
    <>
      ...
      <img src="/weather/moon1.png" alt="moon" className="moon" style={{
        display: !day && (phase==1)? 'block' : 'none'
      }} />
      <img src="/weather/moon2.png" alt="moon" className="moon" style={{
        display: !day && (phase==2)? 'block' : 'none'
      }} />
      <img src="/weather/moon3.png" alt="moon" className="moon" style={{
        display: !day && (phase==3)? 'block' : 'none'
      }} />
      <img src="/weather/moon5.png" alt="moon" className="moon" style={{
        display: !day && (phase==5)? 'block' : 'none'
      }} />
      <img src="/weather/moon6.png" alt="moon" className="moon" style={{
        display: !day && (phase==6)? 'block' : 'none'
      }} />
      <img src="/weather/moon7.png" alt="moon" className="moon" style={{
        display: !day && (phase==7)? 'block' : 'none'
      }} />
      <img src="/weather/moon0.png" alt="moon" className="moon" style={{
